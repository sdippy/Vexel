function WatchlistAddCard() {
  return (
    <div className="flex flex-col justify-center items-center gap-[16px] p-5 border-[1px] border-white/10 rounded-[12px] bg-white/[.03] shadow-[0_8_32px_rgba(0,0,0,0.37)]">
